...
// const getTotalBalance = users => users.map(user => user.balance).reduce((acc, value) => acc + value, 0);
// console.log(getTotalBalance(users)); // 20916
//======================================8==================
//Массив имен всех пользователей у которых есть друг с указанным именем.

// const getUsersByFriend = (users, name) => users.reduce(() => {}, []);
const allFriends = users.reduce((acc, user) => {
  acc.push(...name, ...user.friends, )
